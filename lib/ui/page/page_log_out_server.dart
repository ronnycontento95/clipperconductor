...
class PageLogOutServer extends StatefulWidget {
  const PageLogOutServer({super.key, required this.message});

  final String message;

  @override
  State<PageLogOutServer> createState() => _PageLogOutServer();
}

class _PageLogOutServer extends State<PageLogOutServer> {
  @override
  void dispose() {
