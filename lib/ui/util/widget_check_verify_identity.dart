...
import 'global_widgets/widget_icon.dart';
import 'global_widgets/widget_text_field_personalized.dart';

class WidgetVerifyIdentity extends StatefulWidget {
  const WidgetVerifyIdentity({super.key, required this.message});

  final String message;

  @override
  State<WidgetVerifyIdentity> createState() => _WidgetCheckState();
}

class _WidgetCheckState extends State<WidgetVerifyIdentity> {
  @override
  void initState() {
    super.initState();
